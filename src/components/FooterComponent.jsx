...
const footerData = translations[currentLang]?.footerComponent || {};
  ...
  const iconsSocial = [
    {
      ...
      link: "https://www.facebook.com/people/Stake-Dev/61571896937520/",
    },
    {
      id: 1,
      icon: "mdi:instagram",
      link: "https://www.instagram.com/stake.dev/",
    },
    // { id: 3, icon: "ic:baseline-whatsapp", link: "#" },
    {
      id: 4,
      icon: "mdi:linkedin",
      link: "https://www.linkedin.com/company/stake-dev/about/",
    },
  ];
  return (
    <footer>
      <div className="columns-container">
        ...
        <li className="column">
          <h1 className="oswald-title">{footerData.navigate?.title}</h1>
          {footerData.navigate?.navLinks?.map((link) => (
        ...
        <li className="column">
          <h1 className="oswald-title">{footerData.contact}</h1>
        ...
        <li className="column">
          <h1 className="oswald-title">{footerData.info?.title}</h1>
          {footerData.info?.infoLinks?.map((linkInfo) => (
      ...
      <div className="text-footer">
        <small className="poppins-regular">
          &copy; {getYear()} <b>Stake Dev</b> - {footerData.spam}.
        </small>
      </div>
    </footer>
  );
